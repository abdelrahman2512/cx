...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5680297831").split())
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/T_S_T99"
)  # رابط كروبك
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/002f9c9516ec3864f44c1.jpg")
